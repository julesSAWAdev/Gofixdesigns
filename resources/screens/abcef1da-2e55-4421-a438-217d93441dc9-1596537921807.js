jQuery("#simulation")
  .on("click", ".s-abcef1da-2e55-4421-a438-217d93441dc9 .click", function(event, data) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-abcef1da-2e55-4421-a438-217d93441dc9 #s-loginBtn > .backgroundLayer": {
                      "attributes": {
                    ...
                    "#s-abcef1da-2e55-4421-a438-217d93441dc9 #s-loginBtn": {
                      "attributes": {
                        "text-shadow": "none"
                      }
                    }
  ...
  .on("drag", ".s-abcef1da-2e55-4421-a438-217d93441dc9 .drag", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("dragend", ".s-abcef1da-2e55-4421-a438-217d93441dc9 .drag", function(event, data) {
